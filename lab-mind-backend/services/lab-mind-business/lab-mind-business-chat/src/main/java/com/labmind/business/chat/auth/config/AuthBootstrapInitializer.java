...
public class AuthBootstrapInitializer implements ApplicationRunner {
    ...
    private void requireFullBootstrapConfig() {
        requireText(properties.getSuperAdminAccount(), "lab-mind.auth.bootstrap.super-admin-account");
        requireText(properties.getSuperAdminPassword(), "lab-mind.auth.bootstrap.super-admin-password");
        requireText(properties.getSuperAdminDisplayName(), "lab-mind.auth.bootstrap.super-admin-display-name");
        requireText(properties.getWorkspaceId(), "lab-mind.auth.bootstrap.workspace-id");
        requireText(properties.getWorkspaceName(), "lab-mind.auth.bootstrap.workspace-name");
    }
