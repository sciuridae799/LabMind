    ...
    private Driver getRequiredDriver() {
        ...
        synchronized (this) {
            if (driver == null) {
                ...
                validateConfiguredText(properties.getUri(), "LAB_MIND_NEO4J_URI");
                validateConfiguredText(properties.getUsername(), "LAB_MIND_NEO4J_USERNAME");
                validateConfiguredText(properties.getPassword(), "LAB_MIND_NEO4J_PASSWORD");
                validateConfiguredText(properties.getDatabase(), "LAB_MIND_NEO4J_DATABASE");
