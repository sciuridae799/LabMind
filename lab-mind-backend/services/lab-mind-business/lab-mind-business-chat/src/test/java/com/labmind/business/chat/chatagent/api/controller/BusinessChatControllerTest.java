...
class BusinessChatControllerTest {
    ...
    void setUp() {
        ...
        BusinessChatModelApiConfigService modelApiConfigService = new BusinessChatModelApiConfigService() {
            @Override
            public List<com.labmind.business.chat.chatagent.api.vo.BusinessChatModelApiConfigVo> listAll() {
                return List.of();
            }

            @Override
            public List<com.labmind.business.chat.chatagent.api.vo.BusinessChatModelApiConfigVo> listAvailable() {
                return List.of();
            }

            @Override
            public com.labmind.business.chat.chatagent.api.vo.BusinessChatModelApiConfigVo save(
                    com.labmind.business.chat.chatagent.api.dto.BusinessChatModelApiConfigSaveRequest request) {
                return null;
            }

            @Override
            public void delete(com.labmind.business.chat.chatagent.api.dto.BusinessChatModelApiConfigIdRequest request) {
            }

            @Override
            public void clearApiKey(
                    com.labmind.business.chat.chatagent.api.dto.BusinessChatModelApiConfigIdRequest request) {
            }

            @Override
            public void move(com.labmind.business.chat.chatagent.api.dto.BusinessChatModelApiConfigMoveRequest request) {
            }

            @Override
            public com.labmind.business.chat.chatagent.execution.model.BusinessChatModelApiConfigSnapshot getRequiredAvailableSnapshot(
                    String id) {
                return null;
            }

            @Override
            public com.labmind.business.chat.chatagent.execution.model.BusinessChatModelApiConfigSnapshot getLatestAvailableSnapshot() {
                return null;
            }
        };
