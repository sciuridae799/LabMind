# LabMind Redisson Service Lock Framework

`lab-mind-redisson-service-lock-framework` 提供注解式分布式锁能力，基于 `RedissonClient` 和 AOP 完成方法级互斥控制。
...
- 自动配置类：`com.labmind.redisson.servicelock.config.ServiceLockAutoConfiguration`
...
```text
com.labmind.demo.OrderService.submit:42:submit
```
...
/Users/admin/Documents/apache-maven-3.9.11/bin/mvn \
  ...
  -pl lab-mind-backend/frameworks/lab-mind-redisson-framework/lab-mind-redisson-service-framework/lab-mind-redisson-service-lock-framework \
  -am test
```
