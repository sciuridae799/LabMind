# LabMind Redisson Service Lease Framework

`lab-mind-redisson-service-lease-framework` 提供基于 Lua 脚本的 Redis 租约互斥能力。
...
- 自动配置类：`com.labmind.redisson.servicelease.config.ServiceLeaseAutoConfiguration`
...
/Users/admin/Documents/apache-maven-3.9.11/bin/mvn \
  ...
  -pl lab-mind-backend/frameworks/lab-mind-redisson-framework/lab-mind-redisson-service-framework/lab-mind-redisson-service-lease-framework \
  -am test
```
