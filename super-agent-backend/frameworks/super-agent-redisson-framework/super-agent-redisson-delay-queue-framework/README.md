# Super Agent Redisson Delay Queue Framework

`super-agent-redisson-delay-queue-framework` 提供基于 Redisson 的延迟队列能力。
...
- 自动配置类：`com.superagent.redisson.delayqueue.config.DelayQueueAutoConfig`
- 配置属性类：`com.superagent.redisson.delayqueue.config.DelayQueueProperties`
...
/Users/admin/Documents/apache-maven-3.9.11/bin/mvn \
  ...
  -pl super-agent-backend/frameworks/super-agent-redisson-framework/super-agent-redisson-delay-queue-framework \
  -am test
```
