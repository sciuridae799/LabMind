...
public class SwaggerConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean(name = "superAgentGroupedOpenApi")
    public GroupedOpenApi superAgentGroupedOpenApi() {
    ...
    public OpenAPI superAgentOpenApi(Environment environment) {
