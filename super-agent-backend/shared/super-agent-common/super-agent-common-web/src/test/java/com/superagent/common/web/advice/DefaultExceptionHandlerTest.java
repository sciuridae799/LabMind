package com.superagent.common.web.advice;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.superagent.common.frame.enums.ErrorCode;
import com.superagent.common.frame.exception.SuperAgentFrameException;
...
class DefaultExceptionHandlerTest {
    ...
    void setUp() {
        ...
        new JacksonCustom().superAgentJacksonCustomizer().customize(builder);
    ...
    static class TestController {
        ...
        public ApiResponse<Void> business() {
            throw new SuperAgentFrameException(TestCode.BIZ_ERROR, "business failure");
        }
