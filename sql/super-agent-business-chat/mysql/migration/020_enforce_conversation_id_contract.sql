...
UPDATE super_agent_chat_model_call_trace model_trace_data
INNER JOIN super_agent_chat_dialogue dialogue_data
...
UPDATE super_agent_chat_tool_call_trace tool_trace_data
INNER JOIN super_agent_chat_dialogue dialogue_data
...
UPDATE super_agent_chat_session_state session_state_data
INNER JOIN super_agent_chat_dialogue dialogue_data
...
UPDATE super_agent_knowledge_route_trace route_trace_data
INNER JOIN super_agent_chat_dialogue dialogue_data
...
ALTER TABLE super_agent_chat_exchange
    MODIFY COLUMN dialogue_code VARCHAR(64) COLLATE utf8mb4_bin NOT NULL COMMENT '所属业务会话编号';

ALTER TABLE super_agent_chat_memory_summary
    MODIFY COLUMN dialogue_code VARCHAR(64) COLLATE utf8mb4_bin NOT NULL COMMENT '所属业务会话编号';

ALTER TABLE super_agent_chat_exchange_trace_stage
    MODIFY COLUMN dialogue_code VARCHAR(64) COLLATE utf8mb4_bin NOT NULL COMMENT '所属业务会话编号';

ALTER TABLE super_agent_chat_model_call_trace
    MODIFY COLUMN dialogue_code VARCHAR(64) COLLATE utf8mb4_bin NOT NULL COMMENT '所属业务会话编号';

ALTER TABLE super_agent_chat_tool_call_trace
    MODIFY COLUMN dialogue_code VARCHAR(64) COLLATE utf8mb4_bin NOT NULL COMMENT '所属业务会话编号';

ALTER TABLE super_agent_chat_session_state
    MODIFY COLUMN active_conversation_id VARCHAR(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '聊天页刷新时应恢复的活动会话编号';

ALTER TABLE super_agent_knowledge_route_trace
