-- 记录聊天页刷新时应恢复的活动会话。
CREATE TABLE IF NOT EXISTS lab_mind_chat_session_state (
    ...
    PRIMARY KEY (id),
    UNIQUE KEY uk_lab_mind_chat_session_state_key (state_key),
    KEY idx_lab_mind_chat_session_state_conversation (active_conversation_id, status)
