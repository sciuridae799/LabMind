-- lab-mind-business-chat 对话域建表脚本
CREATE TABLE IF NOT EXISTS lab_mind_chat_dialogue (
    ...
    PRIMARY KEY (id),
    UNIQUE KEY uk_lab_mind_chat_dialogue_code (dialogue_code),
    KEY idx_dialogue_guest_session (workspace_id, auth_session_token, status),
    KEY idx_lab_mind_chat_dialogue_workspace (workspace_id, dialogue_code, status),
    KEY idx_lab_mind_chat_dialogue_code_status (dialogue_code, status),
    KEY idx_lab_mind_chat_dialogue_stage_status (dialogue_stage, status),
    KEY idx_lab_mind_chat_dialogue_edit_time (edit_time)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='业务对话归档主表';

CREATE TABLE IF NOT EXISTS lab_mind_chat_exchange (
    id BIGINT NOT NULL COMMENT '主键id',
    ...
    status TINYINT(1) DEFAULT '1' COMMENT '1:正常 0:删除',
    PRIMARY KEY (id),
    KEY idx_lab_mind_chat_exchange_workspace (workspace_id, dialogue_code, status),
    KEY idx_lab_mind_chat_exchange_dialogue_status (dialogue_code, status),
    KEY idx_lab_mind_chat_exchange_state_status (exchange_state, status),
    KEY idx_lab_mind_chat_exchange_create_time (create_time)
...
CREATE TABLE IF NOT EXISTS lab_mind_chat_memory_summary (
    ...
    status TINYINT(1) DEFAULT '1' COMMENT '1:正常 0:删除',
    PRIMARY KEY (id),
    KEY idx_lab_mind_chat_memory_summary_workspace (workspace_id, dialogue_code, status),
    UNIQUE KEY uk_lab_mind_chat_memory_summary_dialogue (dialogue_code),
    KEY idx_lab_mind_chat_memory_summary_cover (covered_exchange_id),
    KEY idx_lab_mind_chat_memory_summary_edit_time (edit_time)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='业务对话长期记忆摘要快照表';

CREATE TABLE IF NOT EXISTS lab_mind_chat_exchange_trace_stage (
    id BIGINT NOT NULL COMMENT '主键id',
    dialogue_code VARCHAR(64) COLLATE utf8mb4_bin NOT NULL COMMENT '所属业务会话编号',
    workspace_id VARCHAR(64) NOT NULL COMMENT '所属工作组id',
    ...
    start_time DATETIME(3) DEFAULT NULL COMMENT '阶段开始时间',
    end_time DATETIME(3) DEFAULT NULL COMMENT '阶段结束时间',
    ...
    status TINYINT(1) DEFAULT '1' COMMENT '1:正常 0:删除',
    PRIMARY KEY (id),
    KEY idx_lab_mind_chat_trace_workspace (workspace_id, dialogue_code, exchange_id, status),
    KEY idx_lab_mind_chat_trace_exchange (exchange_id, stage_order),
    KEY idx_lab_mind_chat_trace_dialogue (dialogue_code, exchange_id),
    KEY idx_lab_mind_chat_trace_trace_id (trace_id),
    KEY idx_lab_mind_chat_trace_stage_code (stage_code)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='对话轮次执行阶段轨迹表';

CREATE TABLE IF NOT EXISTS lab_mind_chat_model_call_trace (
    id BIGINT NOT NULL COMMENT '主键id',
    dialogue_code VARCHAR(64) COLLATE utf8mb4_bin NOT NULL COMMENT '所属业务会话编号',
    exchange_id BIGINT NOT NULL COMMENT '所属轮次id',
    trace_id VARCHAR(64) NOT NULL COMMENT '本轮执行trace id',
    ...
    status TINYINT(1) DEFAULT '1' COMMENT '1:正常 0:删除',
    PRIMARY KEY (id),
    KEY idx_lab_mind_chat_model_call_exchange (exchange_id, start_time),
    KEY idx_lab_mind_chat_model_call_dialogue (dialogue_code, exchange_id),
    KEY idx_lab_mind_chat_model_call_trace (trace_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='对话模型调用用量追踪表';

CREATE TABLE IF NOT EXISTS lab_mind_chat_tool_call_trace (
    id BIGINT NOT NULL COMMENT '主键id',
    dialogue_code VARCHAR(64) COLLATE utf8mb4_bin NOT NULL COMMENT '所属业务会话编号',
    exchange_id BIGINT NOT NULL COMMENT '所属轮次id',
    trace_id VARCHAR(64) NOT NULL COMMENT '本轮执行trace id',
    ...
    status TINYINT(1) DEFAULT '1' COMMENT '1:正常 0:删除',
    PRIMARY KEY (id),
    KEY idx_lab_mind_chat_tool_call_exchange (exchange_id, start_time),
    KEY idx_lab_mind_chat_tool_call_dialogue (dialogue_code, exchange_id),
    KEY idx_lab_mind_chat_tool_call_trace (trace_id)
...
CREATE TABLE IF NOT EXISTS lab_mind_chat_session_state (
    ...
    KEY idx_lab_mind_chat_session_state_workspace (workspace_id, state_key, status),
